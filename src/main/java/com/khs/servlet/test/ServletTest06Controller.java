...
public class ServletTest06Controller extends HttpServlet{
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		//{"addtion":1524, "subtraction":141, "multiplication":211511, "division":15}
		
		out.println("{\"addtion\":" + addition + ", \"subtraction\":" + subtraction + ", \"multiplication\":" + multiplication + ", \"division\":" + division + "}");
